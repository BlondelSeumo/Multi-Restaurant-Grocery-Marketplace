...
class WalletHistory extends ConsumerStatefulWidget {
  const WalletHistory({Key? key}) : super(key: key);

  @override
  ConsumerState<WalletHistory> createState() => _WalletHistoryState();
}

class _WalletHistoryState extends ConsumerState<WalletHistory> {
