...
class CreateShop extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CreateShop> createState() => _EditRestaurantState();
}

class _EditRestaurantState extends ConsumerState<CreateShop>
                                          ...
                                          onTap: ()  {
                                            AppHelpers.showAlertDialog(
                                                ...
                                                child: Container(
                                                  ...
                                                  padding:
                                                  EdgeInsets.symmetric(horizontal: 6.r, vertical: 8.r),
                                                  child: Column(
                                                    mainAxisSize: MainAxisSize.min,
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: [
                                                      TitleAndIcon(
                                                          title: AppHelpers.getTranslation(TrKeys.select)),
                                                      24.verticalSpace,
                                                      CustomButton(
                                                          title: AppHelpers.getTranslation(
                                                              TrKeys.generateImageWithChatGPT),
                                                          onPressed: () async {
                                                            context.popRoute();
                                                            ref.refresh(generateImageProvider);
                                                            final photoUrl = await context
                                                                .pushRoute(const GenerateImageRoute());
                                                            ImageCropperForMarker imageMarker =
                                                            ImageCropperForMarker();
                                                            final file = await imageMarker
                                                                .urlToFile(photoUrl as String);
