                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, indexCart) {
                          return CartOrderItem(
                            ...
                            add: () => LocalStorage.instance.getUserId() ==
                                    state.cart?.ownerId
                                ...
                                : event.addCountWithGroup(
                                    ...
                                    userIndex: index),
                            remove: () => LocalStorage.instance.getUserId() ==
                                    state.cart?.ownerId
        ...
        children: [
          Padding(
            ...
            child: Column(
              children: [
                ...
                // ShopOrderDescription(
                //   price: (state.cart?.shopTax ?? 0) *
                //       (state.cart?.totalPrice ?? 0) /
                //       100,
                //   svgName: "assets/svgs/servic.svg",
          ...
          Padding(
            ...
            child: CustomButton(
              ...
              title:
                  (state.cart?.ownerId != LocalStorage.instance.getUserId() &&
                          (state.cart?.group ?? false))
                      ? (state.isEditOrder
              ...
              onPressed: () {
                if ((state.cart?.ownerId != LocalStorage.instance.getUserId() &&
                    (state.cart?.group ?? false))) {
