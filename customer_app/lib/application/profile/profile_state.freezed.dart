...
class _$_ProfileState extends _ProfileState {
  ...
  @override
  String toString() {
    return 'ProfileState(isLoading: $isLoading, isReferralLoading: $isReferralLoading, isSaveLoading: $isSaveLoading, isLoadingHistory: $isLoadingHistory, typeIndex: $typeIndex, bgImage: $bgImage, logoImage: $logoImage, addressModel: $addressModel, userData: $userData, referralData: $referralData, walletHistory: $walletHistory)';
  }
...
abstract class _ProfileState extends ProfileState {
  const factory _ProfileState(
      ...
      final ProfileData? userData,
      final ReferralModel? referralData,
      final List<WalletData>? walletHistory}) = _$_ProfileState;
