...
class _$_OrderState extends _OrderState {
  ...
  @override
  String toString() {
    return 'OrderState(isActive: $isActive, isOrder: $isOrder, isLoading: $isLoading, isMapLoading: $isMapLoading, isButtonLoading: $isButtonLoading, isTodayWorkingDay: $isTodayWorkingDay, isTomorrowWorkingDay: $isTomorrowWorkingDay, isCheckShopOrder: $isCheckShopOrder, isAddLoading: $isAddLoading, promoCode: $promoCode, office: $office, house: $house, floor: $floor, note: $note, selectTime: $selectTime, selectDate: $selectDate, startTodayTime: $startTodayTime, endTodayTime: $endTodayTime, startTomorrowTime: $startTomorrowTime, endTomorrowTime: $endTomorrowTime, tabIndex: $tabIndex, branchIndex: $branchIndex, orderData: $orderData, shopData: $shopData, branches: $branches, calculateData: $calculateData, markers: $markers, shopMarkers: $shopMarkers, polylineCoordinates: $polylineCoordinates)';
  }
...
abstract class _OrderState extends OrderState {
  const factory _OrderState(
      ...
      final List<LatLng> polylineCoordinates}) = _$_OrderState;
