...
/// @nodoc
abstract class _$$_TimeStateCopyWith<$Res> implements $TimeStateCopyWith<$Res> {
  factory _$$_TimeStateCopyWith(
          _$_TimeState value, $Res Function(_$_TimeState) then) =
      __$$_TimeStateCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int currentIndexOne, int currentIndexTwo, int? selectIndex});
}
...
/// @nodoc
class __$$_TimeStateCopyWithImpl<$Res>
    extends _$TimeStateCopyWithImpl<$Res, _$_TimeState>
    implements _$$_TimeStateCopyWith<$Res> {
  __$$_TimeStateCopyWithImpl(
      _$_TimeState _value, $Res Function(_$_TimeState) _then)
      : super(_value, _then);
...
class _$_TimeState extends _TimeState {
  const _$_TimeState(
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_TimeStateCopyWith<_$_TimeState> get copyWith =>
      __$$_TimeStateCopyWithImpl<_$_TimeState>(this, _$identity);
}
...
abstract class _TimeState extends TimeState {
  const factory _TimeState(
      {final int currentIndexOne,
      final int currentIndexTwo,
      final int? selectIndex}) = _$_TimeState;
